...
def l7_createFeatureCollection_estimates():
    return  ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1') \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_enf_NNT1_Single_0_1')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1')) \
    ...
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_mix_NNT1_Single_0_1')) 

def l7_createFeatureCollection_errors():
    return  ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes') \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_enf_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1_incertitudes')) \
    ...
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_mix_NNT1_Single_0_1_incertitudes')) 
...
def l7_createFeatureCollection_domains():
    return  ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_domain') \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_dbf_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_enf_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_dbf_domain')) \
    ...
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_mix_domain')) 
...
def l8_createFeatureCollection_estimates():
    ...
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1')) \
...
def l8_createFeatureCollection_errors():
    ...
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1_incertitudes')) \
...
def l8_createFeatureCollection_domains():
    ...
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_ccrs_sobol_4sail2_dbf_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_ccrs_sobol_4sail2_enf_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_ccrs_sobol_4sail2_dbf_domain')) \
    ...
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_weiss_or_prosail_domain')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_ccrs_sobol_4sail2_mix_domain')) 
...
def l9_createFeatureCollection_estimates():
    ...
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1')) \
...
def l9_createFeatureCollection_errors():
    ...
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_ccrs_sobol_4sail2_enf_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_weiss_or_prosail_NNT1_Single_0_1_incertitudes')) \
    .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1_incertitudes')) \
...
def s2_createFeatureCollection_estimates():
    return  ee.FeatureCollection('users/rfernand387/COPERNICUS_S2_SR/s2_sl2p_weiss_or_prosail_NNT3_Single_0_1') \
     ...
     .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/s2_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1')) \
...
def s2_createFeatureCollection_errors():
    return   ee.FeatureCollection('users/rfernand387/COPERNICUS_S2_SR/s2_sl2p_weiss_or_prosail_NNT3_Single_0_1_error') \
      ...
      .merge(ee.FeatureCollection('projects/ee-modis250/assets/SL2P/s2_sl2p_ccrs_sobol_4sail2_dbf_NNT1_Single_0_1_incertitudes')) \
