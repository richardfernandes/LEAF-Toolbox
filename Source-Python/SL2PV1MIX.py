...
def s2_createFeatureCollection_estimates():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/s2_sl2p_ccrs_sobol_4sail2_mix_NNT1_Single_0_1')


def s2_createFeatureCollection_errors():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/s2_sl2p_ccrs_sobol_4sail2_mix_NT1_Single_0_1_incertitudes')


def s2_createFeatureCollection_domains():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/s2_sl2p_ccrs_sobol_4sail2_mix_domain')
...
def l8_createFeatureCollection_estimates():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_ccrs_sobol_4sail2_mix_NNT1_Single_0_1')


def l8_createFeatureCollection_errors():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_ccrs_sobol_4sail2_mix_NT1_Single_0_1_incertitudes')


def l8_createFeatureCollection_domains():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l8_sl2p_ccrs_sobol_4sail2_mix_domain')
...
def l9_createFeatureCollection_estimates():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_ccrs_sobol_4sail2_mix_NNT1_Single_0_1')


def l9_createFeatureCollection_errors():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_ccrs_sobol_4sail2_mix_NT1_Single_0_1_incertitudes')


def l9_createFeatureCollection_domains():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l9_sl2p_ccrs_sobol_4sail2_mix_domain')
...
def l7_createFeatureCollection_estimates():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_mix_NNT1_Single_0_1')


def l7_createFeatureCollection_errors():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_mix_NT1_Single_0_1_incertitudes')


def l7_createFeatureCollection_domains():
    return ee.FeatureCollection('projects/ee-modis250/assets/SL2P/l7_sl2p_ccrs_sobol_4sail2_mix_domain')
